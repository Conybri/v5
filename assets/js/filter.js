...
favoriteBtn.addEventListener('click', () => {
    // Filtramos los usuarios favoritos
    const favoriteUsers = users.filter(user => user.isFavorite);
    
    // Renderizamos solo los favoritos
    renderUsers(favoriteUsers);
});

const showAllFavorite = document.getElementById('showAllFavorite');
showAllFavorite.addEventListener('click', () => {
    // Filtramos los usuarios favoritos
